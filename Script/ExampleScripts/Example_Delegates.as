...
class AExampleEventActor : AActor
{
	...
	void BindExampleDelegates()
	{
		...
		// Global functions can also be bound by leaving off the object parameter.
		ExampleEvent.AddUFunction(n"ExampleGlobalFunction");
...
UFUNCTION()
void ExampleGlobalFunction(UObject InObject, float InValue)
{
	Log("ExampleGlobalFunction: "+InValue);
}
